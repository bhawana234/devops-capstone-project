...
This project contains a capstone journey by developing an Agile plan to build your RESTful microservice

![Build Status](https://github.com/bhawana234/devops-capstone-project/actions/workflows/ci-build.yaml/badge.svg)
